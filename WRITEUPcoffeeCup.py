...
# for the h value of r_ce I multiplied it's linear thermal conductivity by the surface area and divided by it's volume as a rough estimate of it's thermal conductivity per unit area
